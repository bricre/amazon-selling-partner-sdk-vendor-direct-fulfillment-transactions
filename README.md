# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Direct Fulfillment Transaction Status
...
```shell
composer require bricre/amazon-selling-partner-sdk-vendor-direct-fulfillment-transactions
```
...
```php
<?php
use Amz\VendorDirectFulfillmentTransactions\ResponseTypes;
